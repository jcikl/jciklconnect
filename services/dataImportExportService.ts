...
export class DataImportExportService {
  private static validationRules: Record<string, DataValidationRule[]> = {
    members: [
      ...
      { field: 'role', type: 'enum', config: { values: ['GUEST', 'PROBATION', 'MEMBER', 'BOARD', 'ADMIN', 'INACTIVE'] } },
      { field: 'tier', type: 'enum', config: { values: ['Bronze', 'Silver', 'Gold', 'Platinum'] } },
      { field: 'membershipType', type: 'enum', config: { values: ['Guest', 'Full', 'Probation', 'Honorary', 'Visiting', 'Senator'] } },
