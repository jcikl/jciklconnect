...
export function buildCategoryUpdatePayload(
  ...
  else if (cleanup.projectId === null) payload.projectId = null as any;

  if (derived.purpose !== undefined) payload.purpose = derived.purpose;
  else if (cleanup.purpose === null) payload.purpose = null as any;

  if (derived.memberId !== undefined) payload.memberId = derived.memberId as any;
  else if (cleanup.memberId === null) payload.memberId = null as any;
