        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="flex-1 sm:flex-none flex items-center gap-2 border-orange-200 text-orange-600 hover:bg-orange-50 hover:text-orange-700"
            >
                  ...
                  {filteredMembers.length === 0 ? (
                    ...
                    filteredMembers.map((member) => (
                      <tr key={member.memberId} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm">
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${member.isRenewal ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800'
                            }`}>
