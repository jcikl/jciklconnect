            ...
            <div className="rounded-t-[32px] md:rounded-2xl w-full md:max-w-lg shadow-2xl overflow-hidden max-h-[90vh] flex flex-col md:mx-4 animate-slide-up" style={{ background: '#0f172a' }} onClick={e => e.stopPropagation()}>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                ...
                {profileTab === 'professional' && (() => {
                  ...
                  const patchOffer = (k: string, v: string) => setProfileDraft(d => ({ ...d, specialOffer: { ...offerObj, [k]: v } } as unknown as typeof d));
                  return (
                    <div className="space-y-3">
                      {/* Special Member Offer — always editable */}
                      <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">Special Member Offer</p>
                      ...
                      <Select label="Member Benefit"
                        value={offerObj.type}
                        onChange={e => patchOffer('type', e.target.value)}
                      ...
                      <Input label="Expiry Date (optional)" type="date"
                        ...
                        onChange={e => patchOffer('expiryDate', e.target.value)} />

                      {/* Other professional fields */}
                      {professionalCount > 0 && (
                        <>
                          <div className="border-t border-white/10 pt-1" />
                          <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">Other Info</p>
