...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 bottom-0 z-50 w-full ${sizeClasses[size]} bg-white shadow-2xl transition-transform duration-300 ease-in-out ${position === 'right' ? 'right-0' : 'left-0'} ${isOpen ? 'translate-x-0' : (position === 'right' ? 'translate-x-full' : '-translate-x-full')}`}>
